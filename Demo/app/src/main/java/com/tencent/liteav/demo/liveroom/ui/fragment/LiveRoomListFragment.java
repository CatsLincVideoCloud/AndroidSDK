...
public class LiveRoomListFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_live_room_list, container, false);
        if (myInterface != null){
    ...
    public void freshRooms() {
        if (myInterface == null ) {
            myInterface = ((LiveRoomActivityInterface) getActivity());
        ...
        myInterface.getLiveRoom().getRoomList(0, 20, new LiveRoom.GetRoomListCallback() {
            @Override
