...
public class RTCMultiRoomActivity extends CommonAppCompatActivity implements RTCMultiRoomActivityInterface {
    ...
    private final static String DOMAIN = "https://lvb.qcloud.com/weapp/multi_room"; //"https://lvbcloud.com/weapp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gRTCRoom = new RTCRoom(this);
        gRTCRoom.setRTCRoomListener(new MemberEventListener());
        init();
    ...
    protected void onDestroy() {
        super.onDestroy();
        gRTCRoom.setRTCRoomListener(null);
        gRTCRoom.unInit();
    }
